...
var start = function (cb) {
  ...
  /** return number of parking spots and set comprising each parking spot */
  getParkingSpotDetails(config.garage.backend.parkingSpotConfigFile).then(spotMetadata => { // spotMetadata is return value of getParkingSpotDetails
    ...
    wss.on('connection', function connection(ws) {
      logger.log('info', '[CONN RECV] Received at: %s : %d', ws._socket.remoteAddress, ws._socket.remotePort)
      var intObj = null
      //on connect message
