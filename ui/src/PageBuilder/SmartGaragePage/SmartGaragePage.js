...
import overlayImage from '../../assets/virat_dummy_campus_with_buildings_cameras_no_background_bldglayer_extents_transparentbkgd.png';

//import Capacity from '../../Component/Capacity/Capacity';   //TJH disabled display of capacity stats in footer
 ...
 * (1) list window displaying events/anomalies of detected objects; 
...
class SmartGaragePage extends Component {
    ...
    componentDidMount() {
        ...
        const websocket = {
            ...
            startTimestamp: delayTimestamp,    //TJH websocket.starttimestamp no longer used in favor of calcing on the fly in CarMarkers.js
