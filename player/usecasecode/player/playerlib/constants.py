...
NUM_RECS_TO_WRITE = 5
WRITE_RECS_SINCE_LAST = False
IS_LIVE = True

# State Tracking defaults
#------------------------
ENTRY_EXIT_UPDATE_SEC = 5.0
UNDERSTAY_THRESH_SEC = 60.0
STALLED_CAR_THRESH_SEC = 300.00
STALLED_CAR_THRESH_MTR = 4.0
STALLED_CAR_DELETE_SEC = 3600.00
