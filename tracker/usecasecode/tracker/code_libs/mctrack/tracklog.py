...
from code_libs.mctrack import constants
from code_libs.mctrack import trackerutils
...
class MulticamTrackLogger:
    ...
    def __init__(self, config, log_config={}):
        ...
        Returns: None
        """
        log_dir = log_config.get('logDir', '')

        DEBUG_CLUSTER_FILE = log_config.get('DEBUG_CLUSTER_FILE', '')
        if DEBUG_CLUSTER_FILE == '':
            DEBUG_CLUSTER_FILE = None
        else:
            DEBUG_CLUSTER_FILE = os.path.join(log_dir, DEBUG_CLUSTER_FILE)
            
        DEBUG_MATCH_FILE = log_config.get('DEBUG_MATCH_FILE', '')
        if DEBUG_MATCH_FILE == '':
            DEBUG_MATCH_FILE = None
        else:
            DEBUG_MATCH_FILE = os.path.join(log_dir, DEBUG_MATCH_FILE)
            
        DEBUG_INP_POINTS_FILE = log_config.get('DEBUG_INP_POINTS_FILE', '')
        if DEBUG_INP_POINTS_FILE == '':
            DEBUG_INP_POINTS_FILE = None
        else:
            DEBUG_INP_POINTS_FILE = os.path.join(log_dir, DEBUG_INP_POINTS_FILE)
